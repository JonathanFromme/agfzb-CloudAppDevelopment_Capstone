...
def logout_request(request):
    ...
    logout(request)
    # Redirect user back to index list view
    return redirect('djangoapp:index')
...
def get_dealer_details(request, id):
    if request.method == "GET":
        context = {}
        dealer_url = "https://us-south.functions.appdomain.cloud/api/v1/web/01aa7729-df5d-4ea4-a6ec-d070a02ebf9c/dealership-package/get-dealership"
        dealer = get_dealer_by_id_from_cf(dealer_url, id=id)
        context["dealer"] = dealer
    
        review_url = "https://us-south.functions.appdomain.cloud/api/v1/web/01aa7729-df5d-4ea4-a6ec-d070a02ebf9c/dealership-package/get-review"
